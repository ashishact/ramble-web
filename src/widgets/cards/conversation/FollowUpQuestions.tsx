/**
 * MeetingCompanionCards — Meeting companion cards streamed from ChatGPT
 *
...
export function MeetingCompanionCards() {
  ...
  if (!hasMeetingCards) return null;
...
/** @deprecated Use MeetingCompanionCards instead */
export const FollowUpQuestions = MeetingCompanionCards;
