import { BentoNode, BentoTree, LeafNode, NodeMap, SplitNode, Direction } from './types';
...
export const splitNode = (
  ...
  const child1: LeafNode = {
    ...
    type: 'leaf',
    parent: targetId,
    content: (targetNode as LeafNode).content,
    color: (targetNode as LeafNode).color,
  };

  // New Child 2 (Right/Bottom) - new empty leaf
